class Explorer{
    ...
    getNameAndUsername(){
     return `Viajero ${this. name}, username: ${this.username}`
    }
  }
  ...
  const explorer = new Explorer('Omar', 'OmarVenturaP', 'NodeJs')
  const viajero1 = new Viajero("Carlo", "Mission", "Node JS", "Abril 2022")
