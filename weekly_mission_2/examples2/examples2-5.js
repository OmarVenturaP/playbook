class PullRequest {
    ...
    getInfo(){
      return `This PR is in the repo: ${this.repo} (status: ${this.status}), the title is: ${this.title}, and was created on ${this.dateCreated}`
    }
  }
  ...
  const myPR2 = new PullRequest("Playbok", "Weekly Mission", 99)
